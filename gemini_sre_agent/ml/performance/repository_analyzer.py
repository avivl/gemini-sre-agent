...
class PerformanceRepositoryAnalyzer:
    ...
    async def _analyze_error_patterns(self, config: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            error_patterns = [
                ...
                "error", "Error", "Exception", "fail", "Fail"
            ]
    ...
    async def _analyze_testing_patterns(self, config: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            test_patterns = [
                "test_", "Test", "spec", "Spec", "describe", "it(",
                "assert", "expect", "should", "pytest", "unittest"
            ]
        ...
        try:
            ...
            if file_path.name == "package.json":
                ...
                return {
                    ...
                    "package_manager": "npm" if "package-lock.json" in str(self.repo_path) else "yarn"
                }
