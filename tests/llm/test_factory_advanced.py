...
with patch.dict('sys.modules', {
    ...
    from gemini_sre_agent.llm.factory import LLMProviderFactory, get_provider_factory, create_provider_factory
...
class TestFactoryAdvanced:
    ...
    def test_create_providers_from_config(self, factory):
        ...
        with patch('gemini_sre_agent.llm.factory.LiteLLMProvider') as mock_provider_class:
