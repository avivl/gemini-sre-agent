...
from gemini_sre_agent.llm.model_registry import ModelRegistry, ModelInfo
from gemini_sre_agent.llm.model_selector import SelectionStrategy, ModelSelector
from gemini_sre_agent.llm.model_scorer import ScoringWeights
from gemini_sre_agent.llm.performance_cache import PerformanceMonitor, MetricType
...
class TestEnhancedLLMService:
    ...
    async def test_generate_structured_with_model_selection(self):
        ...
        mock_provider.generate_structured.return_value = MockResponse(text="Test response", confidence=0.95)
    ...
    async def test_generate_with_selection_strategy(self):
        ...
        service.model_selector.select_model_with_fallback = Mock(side_effect=[
        ...
        result1 = await service.generate_text(
            prompt="Test prompt",
            selection_strategy=SelectionStrategy.FASTEST
        )
