...
from gemini_sre_agent.source_control.providers.local.local_file_operations import LocalFileOperations
...
class TestLocalFileOperationsConfig:
    ...
    @pytest.fixture
    def file_operations(self, temp_dir, mock_logger, mock_error_handling_components, default_config):
    ...
    async def test_get_file_content_with_config(self, file_operations, temp_dir):
        ...
        file_operations.error_handling_components["resilient_manager"].execute_with_retry = mock_execute_with_retry
