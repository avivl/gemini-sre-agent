...
class TestRepositoryContextCache:
    ...
    async def test_repository_context_caching(self, repo_cache):
        ...
        cached_context = await repo_cache.get_repository_context(
            repo_path, "standard"
        )
    ...
    def test_default_config(self):
        ...
        config = PerformanceConfig(
            ...
            analysis=AnalysisConfig(
                basic_analysis={"max_files": 100, "max_depth": 2, "include_hidden": False, "parallel_workers": 2, "analysis_timeout": 30},
                standard_analysis={"max_files": 500, "max_depth": 3, "include_hidden": False, "parallel_workers": 4, "analysis_timeout": 60},
                comprehensive_analysis={"max_files": 2000, "max_depth": 5, "include_hidden": True, "parallel_workers": 8, "analysis_timeout": 120}
            ),
