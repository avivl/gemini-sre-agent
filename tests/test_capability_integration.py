...
def capability_config():
    ...
    config.add_capability(ModelCapability(
...
def discovery_system(mock_providers, capability_config):
    ...
    with patch('gemini_sre_agent.llm.capabilities.discovery.get_capability_config', return_value=capability_config):
